...
const stateid = (ρid = _ρ, ρuid = _ρu, ρwid = _ρw, ρe_tot_id = _ρe_tot, ρq_tot_id = _ρq_tot)
...
@inline function constant_auxiliary_init!(aux, x, z, _...)
    ...
    # It's not neccesarily the best way to initialize with our model variables.
        p = p_1000 *
            ((p_0 / p_1000)^(R_d / cp_d) - R_d / cp_d * grav / θ_0 / R_m * (z - z_0))^(cp_d /
                                                                                       R_d)
...
function main(
    ...
    numbcflux!(x...) =
        NumericalFluxes.rusanov_boundary_flux!(x..., eulerflux!, bcstate!, wavespeed)
  ...
  # This is a actual state/function that lives on the grid
    ...
    npoststates = 9
    v_q_liq, v_q_vap, v_q_tot, v_p, v_T, v_e_tot, v_e_int, v_e_kin, v_e_pot = 1:npoststates
    postnames = ("q_liq", "q_vap", "q_tot", "p", "T", "e_tot", "e_int", "e_kin", "e_pot")
  ...
  # Set up the information callback
    ...
    Qe = MPIStateArray(spacedisc, (Q, x...) -> single_eddy!(Q, FT(timeend), x...))
