...
function upwindboundaryflux!(fs, nM, stateM, viscM, auxM, stateP, viscP, auxP, bctype, t)
    stateP .= 0
...
function run()
    ...
    spatialdiscretization = setupDG(mpicomm, dim, Ne, polynomialorder, FT, DeviceArrayType)
