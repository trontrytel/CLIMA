...
function run(mpicomm, ArrayType, dim, topl, 
             N, timeend, FT, FastMethod, C_smag, LHF, SHF, C_drag, 
             grid_resolution, domain_size, zmax, zsponge, problem_name, diagnostics_fileout, OUTPATH,LWP_fileout)
  ...
  current_time_str = string(ODESolvers.gettime(ode_solver))
  gather_diagnostics(dg, Q, grid_resolution, current_time_str, diagnostics_fileout,κ,LWP_fileout)
