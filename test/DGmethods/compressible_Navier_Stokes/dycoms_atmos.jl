...
function dycoms_init_state!(state::Vars, aux::Vars, (x,y,z), t)
  # Read sounding 
end

function dycoms_source!(source::Vars, state::Vars, aux::Vars, t::Real)
  x,y,z = aux.coord.x, aux.coord.y, aux.coord.z
  
  function source_geopot!(source::Vars, state::Vars, aux::Vars)
  end
  
  function source_geostrophic!(source::Vars, state::Vars, aux::Vars)
    S_geostrophic_x1 = 
    S_geostrophic_x2 =
  end
  
  source.ρu = SVector(S_geostrophic_x1,
                      S_geostrophic_x2,
                      S_geopotential_z)
  source.ρe = 0 # Radiation Term 
end
