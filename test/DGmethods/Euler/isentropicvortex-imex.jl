...
using CLIMA.MoistThermodynamics: air_density, total_energy, internal_energy, soundspeed_air
...
function run(
    ...
    topology = BrickTopology(mpicomm, brickrange; periodicity = ntuple(_ -> true, dims))
