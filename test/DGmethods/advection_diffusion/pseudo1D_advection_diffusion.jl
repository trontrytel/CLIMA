...
function initial_condition!(::Pseudo1D{n,α,β,μ,δ}, state, aux, x, t) where {n,α,β,μ,δ}
    ξn = dot(n, x)
  # ξT = SVector(x) - ξn * n
  ...
  # Set up the information callback
    ...
    # setup the output callback
        cbvtk = EveryXSimulationSteps(floor(outputtime / dt)) do
            ...
            do_output(mpicomm, vtkdir, vtkstep, dg, Q, Qe, model, "advection_diffusion")
        end
            ...
            for dim = 2:3
                for direction in (EveryDirection, HorizontalDirection, VerticalDirection)
                    ...
                    for l = 1:numlevels
                        ...
                        vtkdir = output ?
                                 "vtk_advection" * "_poly$(polynomialorder)" *
