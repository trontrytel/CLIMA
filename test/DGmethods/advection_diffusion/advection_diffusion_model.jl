...
function init_state!(m::AdvectionDiffusion, state::Vars, aux::Vars, coords, t::Real)
...
###
function boundary_state_Dirichlet!(
...
function boundary_state_Dirichlet!(
  ...
  # data
    init_state!(m, stateP, auxP, auxP.coord, t)
    stateP.ρ = 2 * stateP.ρ - stateM.ρ
end

# Do nothing in this case since the plus-side is the minus side
boundary_state_Dirichlet!(::NumericalFluxDiffusive, ::AdvectionDiffusion, _...) = nothing
