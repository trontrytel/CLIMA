...
@inline function flux_nondiffusive!(m::SWModel, F::Grad, q::Vars, α::Vars, t::Real)
    U = q.U
    η = q.η
    H = m.problem.H
...
@inline function gradvariables!(T::ConstantViscosity, f::Vars, q::Vars, α::Vars, t::Real)
    f.U = q.U
...
function flux_diffusive!(m::SWModel, G::Grad, q::Vars, σ::Vars, α::Vars, t::Real)
...
@inline function source!(m::SWModel{P}, S::Vars, q::Vars, α::Vars, t::Real) where {P}
    τ = α.τ
    f = α.f
    U = q.U
    S.U += τ - f × U
...
function boundary_state!(
    ...
    shallow_boundary_state!(nf, m, m.turbulence, state⁺, aux⁺, n⁻, state⁻, aux⁻, t)
end
...
shallow_boundary_state!(::CentralGradPenalty, m::SWModel, ::LinearDrag, _...) = nothing

shallow_boundary_state!(::CentralNumericalFluxDiffusive, m::SWModel, ::LinearDrag, _...) =
    nothing
