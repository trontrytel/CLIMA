    ...
    # Weak "outside metrics" derivative
        @loop for k in (1:Nqk; threadIdx().z)
            @loop for j in (1:Nq; threadIdx().y)
              ...
              # ξ2-grid lines
                            if dim == 3 || (dim == 2 && direction == EveryDirection)
                                l_rhs[s, i, j, k] += l_ξ2x1[i, j, k] * Dnj *
                                                     s_F[1, i, n, k, s]
                                l_rhs[s, i, j, k] += l_ξ2x2[i, j, k] * Dnj *
                                                     s_F[2, i, n, k, s]
                                l_rhs[s, i, j, k] += l_ξ2x3[i, j, k] * Dnj *
                                                     s_F[3, i, n, k, s]
                            end

              # ξ3-grid lines
                            if dim == 3 && direction == EveryDirection
                                l_rhs[s, i, j, k] += l_ξ3x1[i, j, k] * Dnk *
                                                     s_F[1, i, j, n, s]
                                l_rhs[s, i, j, k] += l_ξ3x2[i, j, k] * Dnk *
                                                     s_F[2, i, j, n, s]
                                l_rhs[s, i, j, k] += l_ξ3x3[i, j, k] * Dnk *
                                                     s_F[3, i, j, n, s]
                            end
                        end
                    end
            ...
            @loop for j in (1:Nq; threadIdx().y)
                @loop for i in (1:Nq; threadIdx().x)
                    ...
                    @unroll for s = 1:nstate
                        ...
                        s_F[1, i, j, k, s] = l_M[i, j, k] *
                                             (l_ξ1x1[i, j, k] * F1 + l_ξ1x2[i, j, k] * F2 +
                                              l_ξ1x3[i, j, k] * F3)
                        if dim == 3 || (dim == 2 && direction == EveryDirection)
    ...
    # Weak "inside metrics" derivative
        @loop for k in (1:Nqk; threadIdx().z)
            @loop for j in (1:Nq; threadIdx().y)
              ...
              # ξ2-grid lines
                            if dim == 3 || (dim == 2 && direction == EveryDirection)
                                l_rhs[s, i, j, k] += MI * s_half_D[n, j] *
                                                     s_F[2, i, n, k, s]
                            end

              # ξ3-grid lines
                            if dim == 3 && direction == EveryDirection
                                l_rhs[s, i, j, k] += MI * s_half_D[n, k] *
                                                     s_F[3, i, j, n, s]
                            end
                        end
                    end
                ...
                @loop for i in (1:Nq; threadIdx().x)
                    @unroll for n = 1:Nq
                        @unroll for s = 1:nstate
                            if dim == 2
                                Dnj = s_half_D[n, j] * s_ω[n] / s_ω[j]
                                l_rhs[s, i, j, k] += l_ζx1[i, j, k] * Dnj *
                                                     s_F[1, i, n, k, s]
                                l_rhs[s, i, j, k] += l_ζx2[i, j, k] * Dnj *
                                                     s_F[2, i, n, k, s]
                                l_rhs[s, i, j, k] += l_ζx3[i, j, k] * Dnj *
                                                     s_F[3, i, n, k, s]
                            else
                                Dnk = s_half_D[n, k] * s_ω[n] / s_ω[k]
                                l_rhs[s, i, j, k] += l_ζx1[i, j, k] * Dnk *
                                                     s_F[1, i, j, n, s]
                                l_rhs[s, i, j, k] += l_ζx2[i, j, k] * Dnk *
                                                     s_F[2, i, j, n, s]
                                l_rhs[s, i, j, k] += l_ζx3[i, j, k] * Dnk *
                                                     s_F[3, i, j, n, s]
                            end
                        end
                    end
            ...
            @loop for j in (1:Nq; threadIdx().y)
                @loop for i in (1:Nq; threadIdx().x)
                    ...
                    @unroll for s = 1:nstate
                        ...
                        s_F[3, i, j, k, s] = l_M[i, j, k] *
                                             (l_ζx1[i, j, k] * F1 + l_ζx2[i, j, k] * F2 +
                                              l_ζx3[i, j, k] * F3)
                    end
                end
            end
